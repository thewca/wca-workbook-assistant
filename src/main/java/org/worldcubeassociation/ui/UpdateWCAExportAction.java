    ...
    private class UpdateWCAExportRunnable implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = new URL("https://www.worldcubeassociation.org/results/misc/export.html");
                ...
                if ( updateAvailable ) {
                    ...
                    if (option == JOptionPane.YES_OPTION) {
                        ...
                        URL exportUrl = new URL("https://www.worldcubeassociation.org/results/misc/" + exportRelativeUrl);
